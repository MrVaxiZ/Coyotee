#ifndef KEYBOARDKEYCODES_H
#define KEYBOARDKEYCODES_H
...
#define VK_OEM_7 				0xDE	// Used for miscellaneous characters; it can vary by keyboard.For the US standard keyboard, the '" key
